...
public class HomeTask {
    ...
    public static void main(String[] args) {
        ...
        switch (s.nextInt()){
            case 1: System.out.println("Input number greater than 0");
                    factorial(s.nextInt());
                    break;

            case 2: System.out.println("Input number greater than 0");
                    int n = s.nextInt();
            ...
            case 3:System.out.println("Input number from 0 to 9");
                   numberToWord(s.nextInt());
                     break;
            default: System.out.println("Error choose from 1 to 3!!!");
        }
    }
